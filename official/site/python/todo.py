    ...
    <header>
      ...
      <nav id="navVertical">
        <ul>
          ...
          <li><a href='completed.py?user=""" + str(user) + "'>" + """ <i class="fa fa-check" aria-hidden="true"></i> &nbsp; &nbsp; &nbsp;Tasks Completed</a></li>
...
for i in data:
    html += i
    html += '<td>'
    html += '<form name="completeTask" method="GET" action="completeTask.py">'
